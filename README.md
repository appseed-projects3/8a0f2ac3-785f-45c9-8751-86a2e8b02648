...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-15 12:39`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8a0f2ac3-785f-45c9-8751-86a2e8b02648.git
$ cd 8a0f2ac3-785f-45c9-8751-86a2e8b02648
```
